...
QT_MOC_LITERAL(1, 7, 9), // "PinSignal"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 7) // "BtnSlot"

    },
    "Engine\0PinSignal\0\0BtnSlot"
};
...
void Engine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->BtnSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::PinSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Engine::PinSignal(QString _t1)
{
