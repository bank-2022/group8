...
QT_MOC_LITERAL(1, 8, 10), // "sendCardID"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 13) // "receiveCardID"

    },
    "RFID125\0sendCardID\0\0receiveCardID"
};
...
void RFID125::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendCardID((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RFID125::sendCardID)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RFID125::sendCardID(QByteArray _t1)
{
